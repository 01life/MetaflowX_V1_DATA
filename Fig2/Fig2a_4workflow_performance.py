...
# 数据（指定顺序）
workflows = ["MetaflowX", "nf-mag", "MetaWRAP", "anvi'o"]
runtime = [5.47, 6.26, 78.03, 50.74]      # 左轴：运行时间（h）
storage = [378, 605, 410, 92]             # 右轴：存储消耗（GB）

# 配色
bar_colors = ["#24B064", "#118ab2", "#f07167","#ffd166"]
line_color = "#333333"
...
ax1.set_ylabel("Workflow Runtime (h)", **label_font, color="#333333")
...
# 输出高质量 PDF 图像
plt.tight_layout()
plt.savefig("Fig2a_4workflow_performance.pdf",
